/*
组队分豆-蒙牛
入口：[组队分豆-蒙牛 (https://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=e319ac3cef964226a29eac2559f1cf57&signUuid=6f40e7d98f374f9a810274976de30840)]
组队分豆-蒙牛
cron "28 1,16,22 * * *" script-path=jd_teamMN.js,tag=组队分豆-蒙牛
*/
...
!(async () => {
    ...
    console.log(`若之前做过该活动，则无法重复入队。\n入口:\nhttps://lzkjdz-isv.isvjcloud.com/pool/captain/4471266?activityId=e319ac3cef964226a29eac2559f1cf57&signUuid=6f40e7d98f374f9a810274976de30840`)
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['6f40e7d98f374f9a810274976de30840']
            $.bean = 0;
