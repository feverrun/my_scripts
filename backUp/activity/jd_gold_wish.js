...
活动入口：京东APP首页右边浮动飘窗
#金榜年终奖
9 0,9 * * * jd_gold_wish.js, tag=年终奖, enabled=true

================Loon==============
[Script]
cron "9 0,9 * * *" script-path=jd_gold_wish.js,tag=年终奖

===============Surge=================
金榜年终奖 = type=cron,cronexp="9 0,9 * * *",wake-system=1,timeout=3600,script-path=jd_gold_wish.js

============小火箭=========
金榜年终奖 = type=cron,script-path=jd_gold_wish.js, cronexpr="9 0,9 * * *", timeout=3600, enable=true
 */
const $ = new Env('金榜年终奖');
...
!(async () => {
    ...
    let res = ["T018v_V7RhwQ_VzXIhub1ACjRQmoaX5kRrbA"]; //await getAuthorShareCode('')
