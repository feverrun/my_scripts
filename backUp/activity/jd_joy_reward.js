...
function getExchangeRewards() {
  return new Promise(resolve => {
    ...
    const option = {
      url: `https://jdjoy.jd.com/common/gift/getBeanConfigs?reqSource=h5&invokeKey=${invokeKey}` + $.validate,
      headers: {
        "Host": "jdjoy.jd.com",
        "Accept": "*/*",
...
function exchange(saleInfoId, orderSource) {
  ...
  return new Promise(resolve => {
    ...
    let lks = md5('' + invokeKey + lkt).toString()
    const option = {
      url: `https://jdjoy.jd.com/common/gift/new/exchange?reqSource=h5&invokeKey=${invokeKey}` + $.validate,
