...
!(async () => {
    ...
    if (cookiesArr.length < 10) {
        //如果ck很少为我助力
        $.tytpacketId = '02a4f1dc8e6946638aea70304dc076a6-MTg4NjI5ODgwMjFfcA!!';
    }
