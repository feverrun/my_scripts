...
let strCKFile = isnewql ? '/ql/data/scripts/CKName_cache.json' : '/ql/scripts/CKName_cache.json';
let strUidFile = isnewql ? '/ql/data/scripts/CK_WxPusherUid.json' : '/ql/scripts/CK_WxPusherUid.json';
