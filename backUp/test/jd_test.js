/*
京东到家水果任务脚本
cron "6 0,9 * * *" script-path=jddj_bean.js,tag=京东到家种水果
*/

const $ = new API("京东到家水果");
const JDDJ_URL = `https://daojia.jd.com/client`
let ckPath = './jdCookie.js';   //ck路径,环境变量:JDDJ_CKPATH
let cookies = [];
let thiscookie = '', deviceid = '';
let axios = $.isNode() ? require('axios') : '';
...
function post(function_id, body){
    return axios({
        url: JDDJ_URL,
        params: {
