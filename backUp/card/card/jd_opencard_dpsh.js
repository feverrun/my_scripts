/*
4.25~5.5 大牌生活范 优价放心购  [gua_opencard135.js]
新增开卡脚本
一次性脚本
...
3.加购5京豆
  (默认不加购 如需加购请设置环境变量[opencard_addSku135]为"true"
4.抽奖 (默认不抽奖 如需抽奖请设置环境变量[opencard_draw135]为"3"
填写要抽奖的次数 不足已自身次数为准
opencard_draw135="3"
填非数字会全都抽奖
...
https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dzlhkkb2cf44b9b60ad047e6174aec
&shareUuid=4c8246c0e1654f809de75ae975cb1006)]
...
[task_local]
#4.19~4.26 大牌联合 春夏约惠
9 15 25-30,1-5 4,5 * jd_opencard_dpsh.js, tag=4.25~5.5 大牌生活范 优价放心购, enabled=true
*/
...
opencard_addSku = $.isNode() ? (process.env.opencard_addSku135 ? process.env.opencard_addSku135 : `${opencard_addSku}`) : ($.getdata('opencard_addSku135') ? $.getdata('opencard_addSku135') : `${opencard_addSku}`);
...
opencard = $.isNode() ? (process.env.opencard135 ? process.env.opencard135 : `${opencard}`) : ($.getdata('opencard135') ? $.getdata('opencard135') : `${opencard}`);
...
openwait = $.isNode() ? (process.env.openwait135 ? process.env.openwait135 : `${openwait}`) : ($.getdata('openwait135') ? $.getdata('openwait135') : `${openwait}`);
...
opencard_draw = $.isNode() ? (process.env.opencard_draw135 ? process.env.opencard_draw135 : opencard_draw) : ($.getdata('opencard_draw135') ? $.getdata('opencard_draw135') : opencard_draw);
    ...
    try {
        ...
        if(!$.addCart && !$.outFlag){
            if(opencard_addSku+"" == "true"){
                ...
                console.log('如需加购请设置环境变量[opencard_addSku135]为"true"');
            }
        }
        if(flag){
            await takePostRequest('activityContent');
        ...
        }else console.log('如需抽奖请设置环境变量[opencard_draw135]为"3" 3为次数');
...
async function joinShop() {
    ...
    return new Promise(async resolve => {
        ...
        const options = {
            url: `https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=bindWithVender&body=${body}&clientVersion=9.2.0&client=H5&uuid=88888&&h5st=20220412164645241%3B3634d1aeada6d9cd11a7526a3a6ac63e%3B169f1%3Btk02wd66f1d7418nXuLjsmO3oJMCxUqKVwIf4q1WRptKRT3nJSrx01oYYBAylbSuyg4sipnEzyEJOZuFjfG2QERcBtzd%3B6b455234e93be4ec963cd7c575d70882b838ba588149a1f54b69c8d0dacf14da%3B3.0%3B1649753205241`,
            headers: {
                'accept': '*/*',
                'accept-encoding': 'gzip, deflate, br',
...
async function getshopactivityId() {
    return new Promise(async resolve => {
        ...
        const options = {
            url: `https://api.m.jd.com/client.action?appid=jd_shop_member&functionId=getShopOpenCardInfo&body=${body}&clientVersion=9.2.0&client=H5&uuid=88888&h5st=&h5st=20220412164645241%3B3634d1aeada6d9cd11a7526a3a6ac63e%3B169f1%3Btk02wd66f1d7418nXuLjsmO3oJMCxUqKVwIf4q1WRptKRT3nJSrx01oYYBAylbSuyg4sipnEzyEJOZuFjfG2QERcBtzd%3B6b455234e93be4ec963cd7c575d70882b838ba588149a1f54b69c8d0dacf14da%3B3.0%3B1649753205241`,
            headers: {
                'accept': '*/*',
                'accept-encoding': 'gzip, deflate, br',
                'accept-language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7',
