/*
4.18~4.30 酒水会员盛典 [gua_opencard121.js]
新增开卡脚本
一次性脚本
...
2.开4张卡 成功开1张 抽1次将
3.加购5京豆
  (默认不加购 如需加购请设置环境变量[opencard_addSku121]为"true"
4.抽奖 (默认不抽奖 如需抽奖请设置环境变量[opencard_draw121]为"3"
5.关注10京豆
6.关注频道10京豆
填写要抽奖的次数 不足已自身次数为准
opencard_draw121="3"
...
————————————————
入口：[ 4.18~4.30 酒水会员盛典 (
https://lzdz1-isv.isvjcloud.com/dingzhi/drinkcategory/piecetoge1/activity?activityId=dz479899c4c94b59984be24e02bcb&shareUuid=ad2522798ee7449bb4a97e72cc1463f4)]
...
[task_local]
#4.18~4.30 酒水会员盛典
6 0 21-31 3 * jd_opencard_hysd.js, tag=3.21~3.31 酒水会员盛典, enabled=true
...
openwait = $.isNode() ? (process.env.openwait121 ? process.env.openwait121 : `${openwait}`) : ($.getdata('openwait121') ? $.getdata('openwait121') : `${openwait}`);
...
!(async () => {
    ...
    $.shareUuid = "5aa3982fbad54778b25ad203283f742a"
...
function joinShop() {
    ...
    return new Promise(async resolve => {
        ...
        // let h5st = "20220419013253430;4863329074885455;8adfb;tk02w82ea1b3218nLFBRF2z58NgESkktYrcw2cvc/hPgSTCd++ajFVVALe2K373JkojE+MatXRi7XKPjEqBsHMSFgoK7;b2fade4429b0a303a69bfbf19708b3573f338324755fdea7608238744d14b311;3.0;1650303173430"
