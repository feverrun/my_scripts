...
https://lzdz1-isv.isvjcloud.com/dingzhi/divi/active/activity?activityId=dz5ba3b5b44e35b7d350806a736090&shareUuid=94b413ad16024330941c661aee6ffe7f)]
...
[task_local]
#3.23~4.10 动感乐活，约惠精彩
49 1 2,5,8,10,24-31 3,4 * jd_opencard_dg.js, tag=3.23~4.10 动感乐活，约惠精彩, enabled=true
...
opencard_addSku = $.isNode() ? (process.env.opencard_addSku123 ? process.env.opencard_addSku123 : `${opencard_addSku}`) : ($.getdata('opencard_addSku123') ? $.getdata('opencard_addSku123') : `${opencard_addSku}`);
...
opencard = $.isNode() ? (process.env.opencard123 ? process.env.opencard123 : `${opencard}`) : ($.getdata('opencard123') ? $.getdata('opencard123') : `${opencard}`);
...
openwait = $.isNode() ? (process.env.openwait123 ? process.env.openwait123 : `${openwait}`) : ($.getdata('openwait123') ? $.getdata('openwait123') : `${openwait}`);
...
opencard_draw = $.isNode() ? (process.env.opencard_draw123 ? process.env.opencard_draw123 : opencard_draw) : ($.getdata('opencard_draw123') ? $.getdata('opencard_draw123') : opencard_draw);
...
!(async () => {
    if ($.isNode()) {
        if(opencard+"" != "true"){
            console.log('如需执行脚本请设置环境变量[opencard123]为"true"')
        }
        if(opencard+"" != "true"){
            return
        }
