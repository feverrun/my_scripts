...
[task_local]
#京喜签到
40 0,8 * * * jd_jxSign.js, tag=京喜签到, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxcfd.png, enabled=true

================Loon==============
[Script]
cron "40 0,8 * * *" script-path=jd_jxSign.js,tag=京喜签到

===============Surge=================
京喜签到 = type=cron,cronexp="40 0,8 * * *",wake-system=1,timeout=3600,script-path=jd_jxSign.js

============小火箭=========
京喜签到 = type=cron,script-path=jd_jxSign.js, cronexpr="40 0,8 * * *", timeout=3600, enable=true
 */
