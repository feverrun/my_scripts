/*
年货节红包
cron 0 0,8,20,22 * * *  https://raw.githubusercontent.com/smiek2121/scripts/master/jd_nhjRed.js
整点跑 红包几率大点
...
SCsfNxf换成自己的返利
export jd_nhjRed_rebateCode="SCsfNxf"
...
rebatePin = $.isNode() ? (process.env.jd_nhjRed_rebatePin ? process.env.jd_nhjRed_rebatePin : `${rebatePin}`) : ($.getdata('jd_nhjRed_rebatePin') ? $.getdata('jd_nhjRed_rebatePin') : `${rebatePin}`);
