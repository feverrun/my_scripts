...
https://lzdz1-isv.isvjcloud.com/dingzhi/highRed/active/activity?activityId=dz919005784fd588d3bb1641ac81ce&shareUuid=5d0feb0e5781410fac04f00d770d982c
cron "1 1 1 1 1" jd_opencard_qmhb.js
*/
...
!(async () => {
    ...
    $.shareUuid = "5d0feb0e5781410fac04f00d770d982c"
...
async function run() {
    try {
        ...
        if($.index % 3 == 0) await $.wait(parseInt(Math.random() * 2000 + 3000, 10))
    } catch (e) {
        console.log(e)
    }
}
...
function geth5st() {
    ...
    let str2 = '';
    let strA = [
        ";ef79a;tk02w99bc1b9818n8uFhR8ks3ryQWMOZzjpDVCINJJH8aP0y2RWFLiJBmLk3Z7j9rhm5cj7DN0w9mIHesqomu0B46h0h;5ab5efd5dc7c3d52dd19a8eaabc7bc99c1b9db800a4208ba1142c8a7c7bf852e;3.0;",
        ...
        ";ef79a;tk02w92631bfa18nhD4ubf3QfNiU8ED2PI270ygsn+vamuBQh0lVE6v7UAwckz3s2OtlFEfth5LbQdWOPNvPEYHuU2Tw;0f36dddeff3f8786663b50bb34665c4e9d60859f8fbe822fb55fd02ed2e84fd2;3.0;",
    ];
