...
活动入口：京喜APP-我的-京喜财富岛
优先内部互助
cron "19 0 * * *" script-path=jd_cfd_mooncake_help.js,tag=京喜财富岛合成珍珠助力
 */
...
function getCfd() {
    return new Promise(async resolve => {
        $.get({
            url: `http://hz.feverrun.top:99/share/get/author?flag=cfd`,
            timeout: 10000
        }, (err, resp, data) => {
            try {
                if (err) {
