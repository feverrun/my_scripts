...
https://lzdz1-isv.isvjcloud.com/dingzhi/bigname/memberday/activity?activityId=dz3eb0e16893aa4f7a91d103a6db0b&shareUuid=5112a74370fe475d857d1b89aa691bc0

cron "6 1,21 28,1-8 2,3 *" jd_opencard_hyr.js
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                '5112a74370fe475d857d1b89aa691bc0',
            ]
            $.bean = 0;
