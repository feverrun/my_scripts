/*
6 1,20 * * * jd_xiaolong.js
*/
const $ = new Env('骁龙');
const jdCookieNode = $.isNode() ? require('./jdCookie.js') : '';
let cookiesArr = [];
let activityID = '',cookie = ''
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        ...
        $.shareUuid = ownCode ? ownCode : "d7e6f75e9b174974a08d17c0fdacbae0";
        hotFlag = false;
...
function takePostRequest(type) {
    ...
    switch (type) {
        ...
        case 'doTask2':
            url = 'https://lzdz-isv.isvjcloud.com/unify/cardTaskDraw/doTask';
            body = `activityId=${activityID}&actorUuid=${actorUuid}&param=${$.param}&taskType=20&pin=${encodeURIComponent(pin)}&shareUuid=${$.shareUuid}`;
            break;
        case 'getTaskList':
