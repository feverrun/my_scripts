...
!(async () => {
    ...
    console.log(`\n入口：https://lzdz1-isv.isvjcloud.com/dingzhi/tiger/gold/activity/15725835?activityId=dz2201100014002401&shareUuid=55f6e7c2be1446b5b29c809c58c06d36\n`);
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['55f6e7c2be1446b5b29c809c58c06d36',]
            $.bean = 0;
