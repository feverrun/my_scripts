act_list = [
    {'act_name': '赚积分', 'aid': 1418,
     ...
     'extra_draw_cookie': 'app_innerutm={"us":"gerenzhongxin","um":"hudongleyuan","uc":"yingjifen","ut":"direct"};app_utm={"utm_source":"direct","utm_medium":"direct","utm_campaign":"direct","utm_term":"direct"};',
    ...
    {'act_name': '天天积分翻倍', 'aid': 675,
     ...
     'extra_draw_cookie': 'app_innerutm={"us":"wode","um":"zuanka","uc":"yingjifen","ut":"direct"};app_utm={"utm_source":"direct","utm_medium":"direct","utm_campaign":"direct","utm_term":"direct"};',
     'lid': 1289,
     'draw_times': 3,
     'end_time': '2033-8-18 23:59:59',  # 长期任务
     'text': '每次扣取10积分'
    ...
    {'act_name': '818周年庆', 'aid': 1506,
     ...
     'if_draw': False,  # 已修复抽奖，但貌似仍然不中奖？先设置为False，请自行测试，如不需要抽奖请自行修改为False
     'extra_draw_cookie': 'app_innerutm={"uc":"zhounianqing","um":"youshangjiao","ut":"direct","us":"shouye"};app_utm={"utm_source_app":"direct","utm_campaign_app":"direct","utm_term_app":"direct","utm_medium_app":"direct"};',
     'lid': 1516,
     'draw_times': 3,
