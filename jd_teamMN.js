...
瓜分脚本单独跑
cron "7 5,15 6-30,1-31 4,5 *" jd_teamMN.js
*/
const $ = new Env("蒙牛");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ["f24703dd855b4925b170350b528fb8bd",]
            $.bean = 0;
...
async function bindWithVender(body, venderId) {
    $.h5st = '20220415142221475%3B2256809157167434%3B8adfb%3Btk02wa92e1c8118nKZRMrrPH63dbMsR0vTlHVpUd6lqfVKNV6dQMMJJFO9jvVzMFyOuRYKH2iZAZijXKJDhoJgWkKtKx%3B42cbc94f19d8e07aa9cdcac565600876790780642b5cedcc420a1094cd8a197b%3B3.0%3B1650003741475'
    let opt = {
