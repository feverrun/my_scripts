    ...
    axios({
        ...
        if(res.status == 200 && res.data) {
            if(res.data.success==true){
                console.log(`挖到${res.data.data.chunk.value}`)
...
function home() {
    ...
    axios({
        ...
        if (res.status == 200 && res.data) {
            if (res.data.success == true) {
                curRound = res.data.data.curRound
                console.log('第' + curRound + '关')
                console.log(`export fcwbinviteCode='${res.data.data.inviteCode}'`)
                console.log(`export fcwbinviter='${res.data.data.markedPin}'`)
            } else {
...
function getAuthorShareCode() {
    axios({
        ...
        .then(function (res) {
        if (res.status == 200  && res.data) {
               $.authorCode = JSON.parse(res.data)
        }
    })
