...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://raw.fastgit.org/feverrun/updateTeam/main/shareCodes/jxhb.json') || [];
...
function getAuthorShareCode(url = "https://raw.fastgit.org/feverrun/updateTeam/main/shareCodes/jxhb.json") {
  return new Promise(resolve => {
    const options = {
