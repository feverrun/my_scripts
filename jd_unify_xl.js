/*
cron "18 1,14,17,21 * * *" script-path=jd_unify_xl.js,tag=组队分豆-骁龙
活动地址： https://lzdz-isv.isvjcloud.com/unify/common/activity/?activityId=bc48caef4ff94713a9b0596e256c29bf&shareUuid=d7e6f75e9b174974a08d17c0fdacbae0
 */
const $ = new Env("骁龙");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = ['d7e6f75e9b174974a08d17c0fdacbae0']
            $.bean = 0;
...
async function unify() {
    ...
    if ($.token) {
        ...
        if ($.secretPin) {
            ...
            $.log("任务1")
            await task('unify/cardTaskDraw/doTask', `activityId=${$.activityId}&actorUuid=${encodeURIComponent($.actorUuid)}&param=null&taskType=20&pin=${encodeURIComponent($.secretPin)}&shareUuid=d7e6f75e9b174974a08d17c0fdacbae0}`)
            await $.wait(2000)
            $.log("任务1")
