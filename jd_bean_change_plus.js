...
function taskJDZZUrl(functionId, body = {}) {
  return {
    url: `${JD_API_HOST}?functionId=${functionId}&body=${encodeURIComponent(JSON.stringify(body))}&client=wh5&clientVersion=9.1.0`,
    headers: {
      'Cookie': cookie,
      'Host': 'api.m.jd.com',
      'Connection': 'keep-alive',
...
function taskMsPostUrl(function_id, body = {}, extra = '', function_id2) {
  ...
  return {
    url,
    body: `functionId=${function_id}&body=${encodeURIComponent(JSON.stringify(body))}&client=wh5&clientVersion=1.0.0&${extra}`,
    headers: {
      "Cookie": cookie,
...
function taskcashUrl(_0x7683x2, _0x7683x3 = {}) {
  ...
  return {
    url: `${__Oxb24bc[0x8]}${JD_API_HOST}${__Oxb24bc[0x9]}${_0x7683x2}${__Oxb24bc[0xa]}${encodeURIComponent(JSON[__Oxb24bc[0x1]](_0x7683x3))}${__Oxb24bc[0xb]}${_0x7683x4}${__Oxb24bc[0xc]}${_0x7683x8}${__Oxb24bc[0x8]}`,
    headers: {
      'Host': __Oxb24bc[0xd],
...
function ddFactoryTaskUrl(function_id, body = {}, function_id2) {
  ...
  return {
    url,
    body: `functionId=${function_id}&body=${encodeURIComponent(JSON.stringify(body))}&client=wh5&clientVersion=1.1.0`,
    headers: {
