...
————————————————
入口：[ 3.2-3.8 诠释你的每一面 ]
https://lzdz1-isv.isvjcloud.com/dingzhi/fashion/union/activity?activityId=dz3438d88c47209a29355c6192b127&shareUuid=012ad94f82dd4d64a8e278de7cf56d69
请求太频繁会被黑ip
过10分钟再执行

[task_local]
#3.2-3.8 诠释你的每一面
4 2,20 2-8 3 * jd_opencard_qs.js, tag=3.2-3.8 诠释你的每一面, enabled=true
...
!(async () => {
    ...
    authorCodeList = [
        '012ad94f82dd4d64a8e278de7cf56d69',
    ]
