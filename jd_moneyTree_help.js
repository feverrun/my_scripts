...
[task_local]
#摇钱树助力
30 * * * * https://raw.githubusercontent.com/feverrun/JD_tencent_scf/main/jd_moneyTree_help.js, tag=摇钱树助力, enabled=true

================Loon==============
[Script]
cron "30 * * * *" script-path=https://raw.githubusercontent.com/feverrun/JD_tencent_scf/main/jd_moneyTree_help.js,tag=摇钱树助力

===============Surge=================
摇钱树助力 = type=cron,cronexp="30 * * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/feverrun/JD_tencent_scf/main/jd_moneyTree_help.js

============小火箭=========
摇钱树助力 = type=cron,script-path=https://raw.githubusercontent.com/feverrun/JD_tencent_scf/main/jd_moneyTree_help.js, cronexpr="30 * * * *", timeout=200, enable=true
*
*/
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.shareCodesArr[$.index - 1]) {
      ...
      console.log(`您第${$.index}个京东账号未提供shareCode 将为作者助力! \n`)
