/*
cron "8 1 8-14 3 *" jd_opencardLH3.js
*/
const $ = new Env("3.08-3.14大牌集合");
...
!(async () => {
    ...
    for (let i = 0; i < cookiesArr.length; i++) {
        if (cookiesArr[i]) {
            ...
            authorCodeList = [
                'JnGd3fFQ9edqNXqS3kHNFFs/ye9oluZX4nOTK56TeMXbR7I2OlzZch4hTs22oCUS',
            ]
            $.appkey = "51B59BB805903DA4CE513D29EC448375"
            $.userId = "10299171"
            $.actId = "799c5e6194fa4e3081f2f38_220308"
