...
3.加购5京豆
  (默认不加购 如需加购请设置环境变量[opencard_addSku134]为"true"
4.抽奖 (默认不抽奖 如需抽奖请设置环境变量[opencard_draw134]为"3"
填写要抽奖的次数 不足已自身次数为准
opencard_draw134="3"
填非数字会全都抽奖
...
https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity?activityId=dzlhkk081f1bc4bacd11ec99b60200
&shareUuid=e075d0ae9b3749e8bc4fed3bb85af4c9)]
...
opencard = $.isNode() ? (process.env.opencard134 ? process.env.opencard134 : `${opencard}`) : ($.getdata('opencard134') ? $.getdata('opencard134') : `${opencard}`);
